...
public interface TicketService {
    ...
    List<TicketResponseDto> getAllTickets(TicketStatus status); //
    TicketResponseDto respondToTicket(Long requestId, String response);
    TicketResponseDto updateStatus(Long requestId, TicketStatus status);
}
